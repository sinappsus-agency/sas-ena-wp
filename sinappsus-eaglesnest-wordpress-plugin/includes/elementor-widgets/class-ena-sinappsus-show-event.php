...
class Ena_Sinappsus_Show_Event_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'ena_sinappsus_show_event_widget';
    }

    public function get_title() {
        return __( 'ENA Show Events', 'ena-sinappsus-plugin' );
    }
    ...
    protected function render() {
        ...
        echo do_shortcode('[ena_show_events sales_funnel_id="' . esc_attr($sales_funnel_id) . '"]');
    }
